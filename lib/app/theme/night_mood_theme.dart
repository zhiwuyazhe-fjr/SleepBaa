  ...
  static NightMoodPalette fromMood(NightMood? mood) {
    return switch (mood) {
      NightMood.happy => const NightMoodPalette(
        ...
        welcomeTextOnAccent: Color(0xFF23151B),
        welcomeSurfaceColor: Color(0xFF32272E),
        heroGradientStart: Color(0xFF8F335F),
        heroGradientMid: Color(0xFF74294F),
        heroGradientEnd: Color(0xFF56203B),
      ...
      NightMood.sad => const NightMoodPalette(
        ...
        welcomeTextOnAccent: Color(0xFF251613),
        welcomeSurfaceColor: Color(0xFF332926),
        heroGradientStart: Color(0xFF8A4C36),
        heroGradientMid: Color(0xFF6E3B2A),
        heroGradientEnd: Color(0xFF4F291F),
      ...
      NightMood.calm => const NightMoodPalette(
        ...
        welcomeTextOnAccent: Color(0xFF14211C),
        welcomeSurfaceColor: Color(0xFF24302B),
        heroGradientStart: Color(0xFF1D6F63),
        heroGradientMid: Color(0xFF16584F),
        heroGradientEnd: Color(0xFF0E3F39),
      ...
      null => const NightMoodPalette(
        ...
        welcomeTextOnAccent: AppColors.primaryDeep,
        welcomeSurfaceColor: Color(0xFF223040),
        heroGradientStart: Color(0xFF204F96),
        heroGradientMid: Color(0xFF163E7E),
        heroGradientEnd: Color(0xFF0F2D61),
