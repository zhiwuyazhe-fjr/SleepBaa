  ...
  static _DarkMoodTone forMood(NightMood? mood) {
    return switch (mood) {
      NightMood.happy => const _DarkMoodTone(
        ...
        heroStart: Color(0xFF63354F),
        heroMid: Color(0xFF4D2D3F),
      ...
      NightMood.sad => const _DarkMoodTone(
        ...
        heroStart: Color(0xFF65402F),
        heroMid: Color(0xFF4D3328),
      ...
      NightMood.calm => const _DarkMoodTone(
        ...
        heroStart: Color(0xFF315F55),
        heroMid: Color(0xFF294D46),
      ...
      null => const _DarkMoodTone(
        ...
        heroStart: Color(0xFF285D6A),
        heroMid: Color(0xFF244650),
