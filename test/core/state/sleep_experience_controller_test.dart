...
void main() {
  test('exit sleep mode immediately syncs dorm sleeping count back down', () async {
    ...
    final InMemorySleepSessionRepository sleepSessionRepository =
        InMemorySleepSessionRepository(initialUid: authRepository.currentUser.uid);
    final InMemoryFeedbackRepository feedbackRepository =
        InMemoryFeedbackRepository(sleepSessionRepository: sleepSessionRepository);
    ...
    final DormMember currentMember = dormRepository.currentDorm.members.firstWhere(
