...
void main() {
  ...
  testWidgets(
    'selected badge card uses a stronger accent background than unlocked badge cards',
    (WidgetTester tester) async {
      await _pumpApp(
        tester,
        initialLocation: AppRoutes.profile,
      ...
      final AppCard selectedBadgeCard = tester.widget<AppCard>(
        find.byKey(const ValueKey<String>('profile-badge-grid-sleep-master')),
      );
      final AppCard unlockedBadgeCard = tester.widget<AppCard>(
        find.byKey(const ValueKey<String>('profile-badge-grid-early-sleeper')),
      );

      expect(selectedBadgeCard.color, isNot(unlockedBadgeCard.color));
      expect(selectedBadgeCard.color, palette.primaryDeep);
      expect(unlockedBadgeCard.color, palette.primaryHighlight);
    },
  );
